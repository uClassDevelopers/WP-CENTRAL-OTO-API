...
if ($_GET['apikey'] == " ") { //SET
    ...
    $con=mysqli_connect("$servername",$username, $password, $database); 
     ...
     if ($_GET['oto_directory'] == "1") {
              $query = "SELECT * FROM `eter0_oto_directory` WHERE activated=1 ORDER BY `id` ASC";
            ...
            if (mysqli_num_rows($rs) > 0) {
                ...
                while($obj = mysqli_fetch_array($rs)) {
                  $info = array(
                        "id" => $obj['id'], "title" => utf8_encode($obj['title']), "lang" => utf8_encode($obj['lang']), "school_name" => utf8_encode($obj['school_name']), "school_id" => utf8_encode($obj['school_id']), "school_domain" => utf8_encode($obj['school_domain'])
                );
